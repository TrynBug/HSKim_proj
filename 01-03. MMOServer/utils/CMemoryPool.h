...
public:
	long GetInitSize() const { return _initPoolSize; }
	long GetPoolSize() const { return _poolSize; }
	long GetFreeCount() const { return _freeSize; }
	long GetUseCount() const { return _poolSize - _freeSize; }
